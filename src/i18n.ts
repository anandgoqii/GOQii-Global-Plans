  ...
  zh: {
    translation: {
      ...
      success_stories: {
        ...
        story1_name: "ساماي شارما",
        story1_role: "عضو، برنامج الرعاية المزمنة",
        story1_quote: "“وجدت أخيراً شيئاً يبقيني مستمراً.”",
        story1_desc: "في GOQii، يرشدك مدربك في النظام الغذائي والتمارين الرياضية ويساعدك على بناء العقلية الصحيحة لتصبح نسخة أكثر صحة من نفسك.",
        story1_results: "• تحسن الاستمرارية في العادات اليومية\n• تحكم أفضل في الصحة والروتين\n• عقلية أقوى تجاه العافية على المدى الطويل",
        story1_result: "نجاح الرعاية المزمنة",
        story2_name: "العقيد رافي مينوتشا",
        story2_role: "عضو الرعاية المزمنة",
        story2_quote: "“لم يحبطني مدربي أبداً - بل دعمني وحفزني فقط لبناء عادات صحية.”",
        story2_desc: "ساعدتني في الابتعاد عن الأكل غير الصحي والاستمرار في خيارات أفضل.",
        story2_results: "عادات أكل أفضل • استمرارية • عقلية إيجابية",
        story2_result: "نجاح الرعاية المزمنة",
        story3_name: "أبهاي ماراتي",
        story3_role: "عضو",
        story3_quote: "“مع التدريب الصحيح، انتقلت من البداية إلى ركض نصف ماراثون.”",
        story3_desc: "ساعدني GOQii في إعادة ضبط روتيني، والاستمرار، وبناء القدرة على التحمل خطوة بخطوة.",
        story3_results: "لياقة بدنية محسنة • زيادة القدرة على التحمل • مكاسب أداء حقيقية",
        story3_result: "نجاح اللياقة البدنية",
